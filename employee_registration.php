<?php
	include 'process/registration_functions.php';
...
<html lang="en">
	<head>
		...
		<script src="js/employee_info_save.js"></script>
	...
	<body style="background: url('uploads/BG.png'); background-size:cover;">
		...
		<div class="page_border">
			<form id="pic-upload" class="a-form" enctype="multipart/form-data" method="post" width='840'>
				<h1 style="text-align:center;  font-size:47px; color:black"><b>Aling Alaine's Employee Registration</b></h1>
				<div class="a-form-group mt-3" style="float:left; clear:block; width:20%;">
					<div id="pic-box" style='width:170px; height:150px; overflow:hidden; margin-top:55px; margin-left:5px; background:none; border:thin solid #d3d3d3'>
						<img src="<?php echo isset($type) ? "$pic_path" : "uploads/default.png"; ?>" style="width: 100%; height:100%" alt="" id='pic-img'>
					</div>
