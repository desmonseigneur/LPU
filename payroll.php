<?php
	require_once('process/payroll_functions.php');
	...
	<body>
		<div class="container">
			<div class="page_border" style="background-color:white;">
				<h1 class="text-center" style="padding-top:10px; padding-bottom:10px; font-weight:bold;">Sahod ng Empleyado ni Aling Alaine</h1>
				<form class="row" method="post">
					<div class="col">
						<div class="d-flex justify-content-center align-items-center flex-column">
							<h1 class="fs-5 mx-4">Employee Basic Info:</h1>
							<div class="card mb-3 mx-4" style="width: 14rem;">
								<img src="uploads/Picture.png" class="card-img-top" alt="..." height="190">
							...
							<ul class="">
								...
								<li class="list-group-item border-0">
									<div class="row align-items-center">
										...
										<div class="col-md-6"><input type="text" name="department" id='department' class="form-control mb-1" style="height:2rem;" value="<?php echo $department ?>" aria-label="Amount (to the nearest dollar)" disabled></div>
									</div>
								</li>
