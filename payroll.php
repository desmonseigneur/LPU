<?php
	include 'process/payroll_functions_002.php';
	include 'process/payroll_functions_001.php';
...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href="css/payroll_design.css">
			...
			<div class="col">
				<div class="d-flex justify-content-center align-items-center flex-column">
					...
					<div class="card mb-3 mx-4" style="width: 14rem;">
						<img src=<?php echo isset($type) ? "$type" : "uploads/default.png"; ?> class="card-img" alt="..." height="225">
					</div>
				</div>
							...
							<div class="row align-items-center">
								...
								<div class="col-md-6">
									<div class="input-group mb-3" style="height: 2rem;">
										...
										<button class="btn btn-outline-secondary clickable <?php echo isset($_GET['id']) ? "disabled" : "" ?>" type="button" id="search" name='search'>
			...
			<div class="col">
				<div class="col d-flex mt-4">
					<ul class="">
						...
						<li class="list-group-item border-0">
							<div>
								<button type="submit" name="calculate_gross_income" class="btn btn-primary">Gross Income</button>
								<button type="submit" name="calculate_net_income" class="btn btn-primary">Net Income</button>
								<button type="submit" name="new" class="btn btn-warning">New</button>
								<button type="submit" name='<?php echo !isset($isNew)  ? "update" : "save"; ?>' id='<?php echo !isset($isNew) ? "update" : "save"; ?>' class="btn btn-success" style="white-space: nowrap; font-size:0.9rem;"><?php echo !isset($isNew) ? "Update" : "Save"; ?></button>
								<button type='submit' name='print_payslip' class="btn btn-info">Print</button>
